...
class ClockWindow(Gtk.Window):
   ...
   def __init__(self):
      ...
      Gtk.Window.__init__(self,title='Clock') # Call the Gtk.Window constructor 
      ...
      GLib.timeout_add(250,self.setTimeLabel) # Set the clock
...
# We need the alarm window which count down to the begining of an event
